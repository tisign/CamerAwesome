...
typedef NS_ENUM(NSUInteger, CupertinoStabilizationMode) {
  CupertinoStabilizationModeOff = 0,
  CupertinoStabilizationModeStandard = 1,
  CupertinoStabilizationModeCinematic = 2,
  CupertinoStabilizationModeCinematicExtended = 3,
  CupertinoStabilizationModePreviewOptimized = 4,
  CupertinoStabilizationModeCinematicExtendedEnhanced = 5,
  CupertinoStabilizationModeAuto = 6,
};

/// Wrapper for CupertinoStabilizationMode to allow for nullability.
@interface CupertinoStabilizationModeBox : NSObject
@property(nonatomic, assign) CupertinoStabilizationMode value;
...
@property(nonatomic, strong, nullable) CupertinoStabilizationModeBox * stabilizationMode;
@end
