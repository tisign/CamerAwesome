...
@implementation CupertinoStabilizationModeBox
- (instancetype)initWithValue:(CupertinoStabilizationMode)value {
  self = [super init];
  if (self) {
    _value = value;
  }
...
+ (PigeonSensor *)fromList:(NSArray<id> *)list {
  PigeonSensor *pigeonResult = [[PigeonSensor alloc] init];
  PigeonSensorPositionBox *enumBox = GetNullableObjectAtIndex(list, 0);
  pigeonResult.position = enumBox.value;
  PigeonSensorTypeBox *enumBox = GetNullableObjectAtIndex(list, 1);
...
+ (instancetype)makeWithFileType:(nullable CupertinoFileTypeBox *)fileType
    ...
    stabilizationMode:(nullable CupertinoStabilizationModeBox *)stabilizationMode {
...
+ (CupertinoVideoOptions *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.stabilizationMode = GetNullableObjectAtIndex(list, 4);
  return pigeonResult;
}
+ (nullable CupertinoVideoOptions *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    self.stabilizationMode ?: [NSNull null],
  ];
}
@end
...
+ (PigeonSensorTypeDevice *)fromList:(NSArray<id> *)list {
  PigeonSensorTypeDevice *pigeonResult = [[PigeonSensorTypeDevice alloc] init];
  PigeonSensorTypeBox *enumBox = GetNullableObjectAtIndex(list, 0);
  pigeonResult.sensorType = enumBox.value;
...
+ (AnalysisImageWrapper *)fromList:(NSArray<id> *)list {
  AnalysisImageWrapper *pigeonResult = [[AnalysisImageWrapper alloc] init];
  AnalysisImageFormatBox *enumBox = GetNullableObjectAtIndex(list, 0);
  pigeonResult.format = enumBox.value;
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 146: 
      {
        NSNumber *enumAsNumber = [self readValue];
        return enumAsNumber == nil ? nil : [[CupertinoStabilizationModeBox alloc] initWithValue:[enumAsNumber integerValue]];
      }
    case 147: 
      {
        NSNumber *enumAsNumber = [self readValue];
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[PreviewSize class]]) {
    ...
    [self writeByte:139];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[PigeonSensorPositionBox class]]) {
    ...
    [self writeByte:145];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[CupertinoStabilizationModeBox class]]) {
    CupertinoStabilizationModeBox * box = (CupertinoStabilizationModeBox *)value;
    [self writeByte:146];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
...
void SetUpCameraInterfaceWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<CameraInterface> *api, NSString *messageChannelSuffix) {
  ...
  }
  {
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        PigeonSensorPositionBox *enumBox = GetNullableObjectAtIndex(args, 0);
        PigeonSensorPosition arg_sensor = enumBox.value;
