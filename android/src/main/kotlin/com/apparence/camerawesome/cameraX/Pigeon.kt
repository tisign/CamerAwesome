...
enum class CupertinoStabilizationMode(val raw: Int) {
  OFF(0),
  STANDARD(1),
  CINEMATIC(2),
  ...
  companion object {
    fun ofRaw(raw: Int): CupertinoStabilizationMode? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}
...
data class PigeonSensor (
  ...
  companion object {
    ...
    fun fromList(__pigeon_list: List<Any?>): PigeonSensor {
      val position = __pigeon_list[0] as PigeonSensorPosition
      val type = __pigeon_list[1] as PigeonSensorType
...
data class VideoOptions (
  ...
  companion object {
    ...
    fun fromList(__pigeon_list: List<Any?>): VideoOptions {
      ...
      val quality = __pigeon_list[1] as VideoRecordingQuality?
...
data class AndroidVideoOptions (
  ...
  companion object {
    ...
    fun fromList(__pigeon_list: List<Any?>): AndroidVideoOptions {
      ...
      val fallbackStrategy = __pigeon_list[1] as QualityFallbackStrategy?
...
data class CupertinoVideoOptions (
  ...
  val stabilizationMode: CupertinoStabilizationMode? = null

) {
  companion object {
    @Suppress("LocalVariableName")
    fun fromList(__pigeon_list: List<Any?>): CupertinoVideoOptions {
      val fileType = __pigeon_list[0] as CupertinoFileType?
      val codec = __pigeon_list[1] as CupertinoCodecType?
      val fps = __pigeon_list[2].let { num -> if (num is Int) num.toLong() else num as Long? }
      val colorSpace = __pigeon_list[3] as CupertinoColorSpace?
      val stabilizationMode = __pigeon_list[4] as CupertinoStabilizationMode?
      return CupertinoVideoOptions(fileType, codec, fps, colorSpace, stabilizationMode)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
data class PigeonSensorTypeDevice (
  ...
  companion object {
    ...
    fun fromList(__pigeon_list: List<Any?>): PigeonSensorTypeDevice {
      val sensorType = __pigeon_list[0] as PigeonSensorType
...
data class AnalysisImageWrapper (
  ...
  companion object {
    ...
    fun fromList(__pigeon_list: List<Any?>): AnalysisImageWrapper {
      val format = __pigeon_list[0] as AnalysisImageFormat
      ...
      val rotation = __pigeon_list[6] as AnalysisRotation?
...
private object PigeonPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      146.toByte() -> {
        return (readValue(buffer) as Int?)?.let {
          CupertinoStabilizationMode.ofRaw(it)
        }
      }
      147.toByte() -> {
        return (readValue(buffer) as Int?)?.let {
